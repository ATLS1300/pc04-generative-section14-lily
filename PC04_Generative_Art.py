...
schleraColor = random.choice(pastelPinkBlue) # color for the schlera, random 

turtle.pencolor(255,255,255)

# making the outer eye
turtle.fillcolor(schleraColor)
turtle.begin_fill()
turtle.up()
turtle.goto(-150,0)
turtle.down()
...
# making the iris
irisColor = random.choice(randomEyePalettes)
turtle.fillcolor(irisColor)
turtle.begin_fill()
turtle.up()
turtle.goto(0,-50)
turtle.setheading(0)
